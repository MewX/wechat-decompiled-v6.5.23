...
# instance fields
.field final synthetic FY:Landroid/support/v7/app/g;
...
.method constructor <init>(Landroid/support/v7/app/g;Landroid/view/Window$Callback;)V
    ...
    .prologue
    .line 163
    iput-object p1, p0, Landroid/support/v7/app/g$a;->FY:Landroid/support/v7/app/g;
...
.method final a(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    iget-object v0, p0, Landroid/support/v7/app/g$a;->FY:Landroid/support/v7/app/g;
    ...
    .line 187
    iget-object v5, p0, Landroid/support/v7/app/g$a;->FY:Landroid/support/v7/app/g;

    iget-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Ge:Landroid/support/v7/view/b;
    ...
    invoke-virtual {v5}, Landroid/support/v7/app/AppCompatDelegateImplV7;->cO()Landroid/support/v7/app/ActionBar;
    ...
    iput-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Ge:Landroid/support/v7/view/b;
    ...
    invoke-virtual {v5}, Landroid/support/v7/app/AppCompatDelegateImplV7;->cW()V
    ...
    iget-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gf:Landroid/support/v7/widget/ActionBarContextView;

    if-nez v0, :cond_3

    iget-boolean v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->FQ:Z
    ...
    iput-object v9, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gf:Landroid/support/v7/widget/ActionBarContextView;

    new-instance v9, Landroid/widget/PopupWindow;

    sget v10, Landroid/support/v7/a/a$a;->actionModePopupWindowStyle:I

    invoke-direct {v9, v0, v3, v10}, Landroid/widget/PopupWindow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    iput-object v9, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gg:Landroid/widget/PopupWindow;

    iget-object v9, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gg:Landroid/widget/PopupWindow;
    ...
    iget-object v10, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gf:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iget-object v8, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gf:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v8, v0}, Landroid/support/v7/widget/ActionBarContextView;->ay(I)V

    iget-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gg:Landroid/widget/PopupWindow;
    ...
    iput-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gh:Ljava/lang/Runnable;
    ...
    iput-object v8, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Ge:Landroid/support/v7/view/b;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ai;->p(F)Landroid/support/v4/view/ai;

    move-result-object v0

    iput-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gi:Landroid/support/v4/view/ai;

    iget-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gi:Landroid/support/v4/view/ai;
    ...
    iget-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Et:Landroid/view/Window;

    invoke-virtual {v0}, Landroid/view/Window;->getDecorView()Landroid/view/View;

    move-result-object v0

    iget-object v1, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gh:Ljava/lang/Runnable;
    ...
    :cond_7
    iget-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gk:Landroid/view/ViewGroup;

    sget v8, Landroid/support/v7/a/a$f;->action_mode_bar_stub:I
    ...
    invoke-virtual {v5}, Landroid/support/v7/app/AppCompatDelegateImplV7;->cU()Landroid/content/Context;
    ...
    iput-object v8, v0, Landroid/support/v7/widget/ViewStubCompat;->CJ:Landroid/view/LayoutInflater;
    ...
    iput-object v0, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Gf:Landroid/support/v7/widget/ActionBarContextView;
    ...
    :cond_9
    iput-object v3, v5, Landroid/support/v7/app/AppCompatDelegateImplV7;->Ge:Landroid/support/v7/view/b;
...
.method public onWindowStartingActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    iget-boolean v0, v0, Landroid/support/v7/app/g;->FX:Z
