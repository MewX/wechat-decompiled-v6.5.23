...
.field HA:Landroid/support/v7/app/n$a;
...
.field public Ht:Landroid/support/v7/widget/ActionBarOverlayLayout;
...
.field public Hx:Landroid/support/v7/widget/ai;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/app/n;->Hp:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, Landroid/support/v7/app/n;->Hq:Landroid/view/animation/Interpolator;
    ...
    :goto_1
    sput-boolean v1, Landroid/support/v7/app/n;->Hr:Z
...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->jg:Ljava/util/ArrayList;

    .line 101
    const/4 v0, -0x1

    iput v0, p0, Landroid/support/v7/app/n;->Hy:I
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->Hb:Ljava/util/ArrayList;

    .line 121
    const/4 v0, 0x0

    iput v0, p0, Landroid/support/v7/app/n;->HE:I

    .line 123
    iput-boolean v1, p0, Landroid/support/v7/app/n;->HF:Z

    .line 128
    iput-boolean v1, p0, Landroid/support/v7/app/n;->HJ:Z
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->HN:Landroid/support/v4/view/am;
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->HO:Landroid/support/v4/view/am;
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->HP:Landroid/support/v4/view/ao;

    .line 169
    iput-object p1, p0, Landroid/support/v7/app/n;->mActivity:Landroid/app/Activity;
    ...
    .line 172
    invoke-direct {p0, v0}, Landroid/support/v7/app/n;->aJ(Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->Hw:Landroid/view/View;
...
.method public constructor <init>(Landroid/app/Dialog;)V
    ...
    .line 179
    iput-object p1, p0, Landroid/support/v7/app/n;->oa:Landroid/app/Dialog;
...
.method private B(Z)V
    ...
    .line 743
    iget-boolean v0, p0, Landroid/support/v7/app/n;->HG:Z

    iget-boolean v1, p0, Landroid/support/v7/app/n;->HH:Z

    iget-boolean v2, p0, Landroid/support/v7/app/n;->HI:Z
    ...
    .line 747
    iget-boolean v0, p0, Landroid/support/v7/app/n;->HJ:Z

    if-nez v0, :cond_4

    .line 748
    iput-boolean v5, p0, Landroid/support/v7/app/n;->HJ:Z

    .line 749
    iget-object v0, p0, Landroid/support/v7/app/n;->HK:Landroid/support/v7/view/h;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/n;->Hu:Landroid/support/v7/widget/ActionBarContainer;

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ActionBarContainer;->setVisibility(I)V

    iget v0, p0, Landroid/support/v7/app/n;->HE:I

    if-nez v0, :cond_5

    sget-boolean v0, Landroid/support/v7/app/n;->Hr:Z
    ...
    iget-object v2, p0, Landroid/support/v7/app/n;->Hu:Landroid/support/v7/widget/ActionBarContainer;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v7/app/n;->Hu:Landroid/support/v7/widget/ActionBarContainer;
    ...
    iget-object v3, p0, Landroid/support/v7/app/n;->HP:Landroid/support/v4/view/ao;
    ...
    iget-boolean v2, p0, Landroid/support/v7/app/n;->HF:Z

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/app/n;->Hw:Landroid/view/View;
    ...
    iget-object v0, p0, Landroid/support/v7/app/n;->Hw:Landroid/view/View;
    ...
    :cond_3
    sget-object v0, Landroid/support/v7/app/n;->Hq:Landroid/view/animation/Interpolator;
    ...
    iget-object v0, p0, Landroid/support/v7/app/n;->HO:Landroid/support/v4/view/am;

    invoke-virtual {v1, v0}, Landroid/support/v7/view/h;->b(Landroid/support/v4/view/am;)Landroid/support/v7/view/h;

    iput-object v1, p0, Landroid/support/v7/app/n;->HK:Landroid/support/v7/view/h;

    invoke-virtual {v1}, Landroid/support/v7/view/h;->start()V

    :goto_0
    iget-object v0, p0, Landroid/support/v7/app/n;->Ht:Landroid/support/v7/widget/ActionBarOverlayLayout;
    ...
    iget-boolean v0, p0, Landroid/support/v7/app/n;->HF:Z
    ...
    .line 753
    iput-boolean v6, p0, Landroid/support/v7/app/n;->HJ:Z
    ...
    iget-object v3, p0, Landroid/support/v7/app/n;->Hu:Landroid/support/v7/widget/ActionBarContainer;
    ...
    :cond_b
    sget-object v0, Landroid/support/v7/app/n;->Hp:Landroid/view/animation/Interpolator;

    invoke-virtual {v1, v0}, Landroid/support/v7/view/h;->c(Landroid/view/animation/Interpolator;)Landroid/support/v7/view/h;

    invoke-virtual {v1}, Landroid/support/v7/view/h;->dj()Landroid/support/v7/view/h;

    iget-object v0, p0, Landroid/support/v7/app/n;->HN:Landroid/support/v4/view/am;
...
.method private aJ(Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->Ht:Landroid/support/v7/widget/ActionBarOverlayLayout;
    ...
    iput-object p0, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->Mh:Landroid/support/v7/widget/ActionBarOverlayLayout$a;
    ...
    iget-object v3, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->Mh:Landroid/support/v7/widget/ActionBarOverlayLayout$a;

    iget v4, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->LR:I

    invoke-interface {v3, v4}, Landroid/support/v7/widget/ActionBarOverlayLayout$a;->onWindowVisibilityChanged(I)V

    iget v3, v0, Landroid/support/v7/widget/ActionBarOverlayLayout;->Ma:I
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v7/app/n;->GX:Landroid/support/v7/widget/u;
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->Hv:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->Hu:Landroid/support/v7/widget/ActionBarContainer;

    .line 203
    iget-object v0, p0, Landroid/support/v7/app/n;->GX:Landroid/support/v7/widget/u;

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/app/n;->Hv:Landroid/support/v7/widget/ActionBarContextView;
    ...
    .line 214
    iput-boolean v1, p0, Landroid/support/v7/app/n;->Hz:Z
    ...
    .line 219
    invoke-virtual {v0}, Landroid/support/v7/view/a;->dd()Z
    ...
    .line 225
    iget-object v3, p0, Landroid/support/v7/app/n;->Ht:Landroid/support/v7/widget/ActionBarOverlayLayout;

    iget-boolean v3, v3, Landroid/support/v7/widget/ActionBarOverlayLayout;->LW:Z
    ...
    .line 225
    :cond_8
    iput-boolean v1, p0, Landroid/support/v7/app/n;->HM:Z
...
.method private setDisplayOptions(II)V
    ...
    .line 464
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/n;->GX:Landroid/support/v7/widget/u;
...
.method private z(Z)V
    ...
    .line 260
    iput-boolean p1, p0, Landroid/support/v7/app/n;->HD:Z

    .line 262
    iget-boolean v0, p0, Landroid/support/v7/app/n;->HD:Z
    ...
    iget-object v3, p0, Landroid/support/v7/app/n;->Hx:Landroid/support/v7/widget/ai;
    ...
    invoke-static {v3}, Landroid/support/v4/view/z;->Z(Landroid/view/View;)V

    .line 280
    :cond_0
    :goto_2
    iget-object v4, p0, Landroid/support/v7/app/n;->GX:Landroid/support/v7/widget/u;

    iget-boolean v3, p0, Landroid/support/v7/app/n;->HD:Z
    ...
    iget-boolean v4, p0, Landroid/support/v7/app/n;->HD:Z
    ...
    :goto_4
    iput-boolean v1, v3, Landroid/support/v7/widget/ActionBarOverlayLayout;->LX:Z
...
.method public final A(Z)V
    ...
    .prologue
    .line 648
    iput-boolean p1, p0, Landroid/support/v7/app/n;->HF:Z
...
.method public final C(Z)V
    ...
    .line 849
    iget-boolean v0, p0, Landroid/support/v7/app/n;->HI:Z

    if-nez v0, :cond_1

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/app/n;->HI:Z

    iget-object v0, p0, Landroid/support/v7/app/n;->Ht:Landroid/support/v7/widget/ActionBarOverlayLayout;

    if-eqz v0, :cond_0

    invoke-static {}, Landroid/support/v7/widget/ActionBarOverlayLayout;->dO()V
    ...
    invoke-virtual {v0, v2, v6, v7}, Landroid/support/v7/widget/ActionBarContextView;->c(IJ)Landroid/support/v4/view/ai;
    ...
    iput-boolean v2, p0, Landroid/support/v7/app/n;->HI:Z
    ...
    .line 867
    iget-object v1, p0, Landroid/support/v7/app/n;->Hv:Landroid/support/v7/widget/ActionBarContextView;

    const/16 v2, 0x8

    invoke-virtual {v1, v2, v4, v5}, Landroid/support/v7/widget/ActionBarContextView;->c(IJ)Landroid/support/v4/view/ai;
...
.method public final a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    .prologue
    .line 500
    iget-object v0, p0, Landroid/support/v7/app/n;->HA:Landroid/support/v7/app/n$a;
    ...
    .line 507
    invoke-virtual {v0}, Landroid/support/v7/app/n$a;->dc()Z
    ...
    .line 512
    iput-object v0, p0, Landroid/support/v7/app/n;->HA:Landroid/support/v7/app/n$a;
...
.method public final cZ()V
    ...
    .prologue
    .line 670
    iget-boolean v0, p0, Landroid/support/v7/app/n;->HH:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/n;->HH:Z
...
.method public final da()V
    ...
    .line 696
    iput-boolean v1, p0, Landroid/support/v7/app/n;->HH:Z
...
.method public final db()V
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->HK:Landroid/support/v7/view/h;
...
.method public final getThemedContext()Landroid/content/Context;
    ...
    .prologue
    .line 877
    iget-object v0, p0, Landroid/support/v7/app/n;->Hs:Landroid/content/Context;
    ...
    iput-object v1, p0, Landroid/support/v7/app/n;->Hs:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/app/n;->Hs:Landroid/content/Context;
...
.method public final hide()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/n;->HG:Z
...
.method public final isShowing()Z
    ...
    .line 844
    iget-boolean v1, p0, Landroid/support/v7/app/n;->HJ:Z

    if-eqz v1, :cond_1

    if-eqz v0, :cond_0

    iget-object v1, p0, Landroid/support/v7/app/n;->Ht:Landroid/support/v7/widget/ActionBarOverlayLayout;

    invoke-virtual {v1}, Landroid/support/v7/widget/ActionBarOverlayLayout;->dQ()I
...
.method public final onWindowVisibilityChanged(I)V
    ...
    .prologue
    .line 317
    iput p1, p0, Landroid/support/v7/app/n;->HE:I
...
.method public final setDisplayOptions(I)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/app/n;->Hz:Z
...
.method public final show()V
    ...
    .line 654
    iput-boolean v1, p0, Landroid/support/v7/app/n;->HG:Z
...
.method public final w(Z)V
    ...
    .prologue
    .line 1346
    iget-boolean v0, p0, Landroid/support/v7/app/n;->Hz:Z
...
.method public final x(Z)V
    ...
    .prologue
    .line 328
    iput-boolean p1, p0, Landroid/support/v7/app/n;->HL:Z
...
.method public final y(Z)V
    ...
    .prologue
    .line 343
    iget-boolean v0, p0, Landroid/support/v7/app/n;->Ha:Z
    ...
    .line 346
    :cond_1
    iput-boolean p1, p0, Landroid/support/v7/app/n;->Ha:Z

    .line 348
    iget-object v0, p0, Landroid/support/v7/app/n;->Hb:Ljava/util/ArrayList;
    ...
    .line 350
    iget-object v2, p0, Landroid/support/v7/app/n;->Hb:Ljava/util/ArrayList;
