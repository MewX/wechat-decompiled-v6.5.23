...
# instance fields
.field public Ji:Landroid/support/v4/view/am;

.field Jj:Z

.field private final Jk:Landroid/support/v4/view/an;

.field public final ln:Ljava/util/ArrayList;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->Jk:Landroid/support/v4/view/an;
    ...
    iput-object v0, p0, Landroid/support/v7/view/h;->ln:Ljava/util/ArrayList;
...
# virtual methods
.method public final a(Landroid/support/v4/view/ai;)Landroid/support/v7/view/h;
    .locals 1

    .prologue
    .line 48
    iget-boolean v0, p0, Landroid/support/v7/view/h;->Jj:Z

    if-nez v0, :cond_0

    .line 49
    iget-object v0, p0, Landroid/support/v7/view/h;->ln:Ljava/util/ArrayList;
...
.method public final a(Landroid/support/v4/view/ai;Landroid/support/v4/view/ai;)Landroid/support/v7/view/h;
    ...
    .line 57
    iget-object v0, p1, Landroid/support/v4/view/ai;->yK:Ljava/lang/ref/WeakReference;
    ...
    sget-object v1, Landroid/support/v4/view/ai;->yO:Landroid/support/v4/view/ai$g;

    invoke-interface {v1, v0}, Landroid/support/v4/view/ai$g;->ar(Landroid/view/View;)J
...
.method public final b(Landroid/support/v4/view/am;)Landroid/support/v7/view/h;
    ...
    .line 110
    iput-object p1, p0, Landroid/support/v7/view/h;->Ji:Landroid/support/v4/view/am;
...
.method public final cancel()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/h;->Jj:Z

    goto :goto_0
.end method

.method public final dj()Landroid/support/v7/view/h;
    .locals 2
...
.method public final start()V
    ...
    .line 71
    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/h;->Ji:Landroid/support/v4/view/am;

    if-eqz v2, :cond_3

    .line 72
    iget-object v2, p0, Landroid/support/v7/view/h;->Jk:Landroid/support/v4/view/an;
