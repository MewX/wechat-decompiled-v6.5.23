...
.field public JB:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.field public Jz:Landroid/support/v7/view/menu/f$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 74
    sget v1, Landroid/support/v7/a/a$b;->abc_config_allowActionMenuItemTextWithIcon:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v1

    iput-boolean v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JC:Z

    .line 76
    sget-object v1, Landroid/support/v7/a/a$k;->ActionMenuItemView:[I
    ...
    .line 78
    sget v2, Landroid/support/v7/a/a$k;->ActionMenuItemView_android_minWidth:I

    invoke-virtual {v1, v2, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JE:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JG:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JF:I
...
.method static synthetic a(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/ActionMenuItemView$b;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JB:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method static synthetic b(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/f$b;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->Jz:Landroid/support/v7/view/menu/f$b;
...
.method static synthetic c(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/h;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->di:Landroid/support/v7/view/menu/h;
...
.method private dk()V
    ...
    .line 173
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->tX:Ljava/lang/CharSequence;
    ...
    .line 174
    :goto_0
    iget-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jd:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_0

    iget-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->di:Landroid/support/v7/view/menu/h;

    iget v3, v3, Landroid/support/v7/view/menu/h;->KG:I
    ...
    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JC:Z

    if-nez v3, :cond_0

    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JD:Z
...
.method public final a(Landroid/support/v7/view/menu/h;)V
    ...
    .line 112
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->di:Landroid/support/v7/view/menu/h;
    ...
    iput-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jd:Landroid/graphics/drawable/Drawable;
    ...
    iget v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JG:I
    ...
    iget v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JG:I
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JG:I
    ...
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->dk()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->tX:Ljava/lang/CharSequence;
    ...
    .line 121
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JA:Landroid/support/v7/widget/ListPopupWindow$b;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JA:Landroid/support/v7/widget/ListPopupWindow$b;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->di:Landroid/support/v7/view/menu/h;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/f$b;->f(Landroid/support/v7/view/menu/h;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JC:Z
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 246
    invoke-static {p1}, Landroid/support/v4/view/z;->J(Landroid/view/View;)I
    ...
    .line 250
    :cond_1
    iget-object v8, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->di:Landroid/support/v7/view/menu/h;
...
.method protected onMeasure(II)V
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JF:I
    ...
    iget v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JE:I
    ...
    iget v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JE:I
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jd:Landroid/graphics/drawable/Drawable;
    ...
    .line 289
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jd:Landroid/graphics/drawable/Drawable;
    ...
    .line 276
    :cond_3
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JE:I
...
.method public setPadding(IIII)V
    ...
    .prologue
    .line 103
    iput p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->JF:I
