...
.field public JI:Landroid/content/Context;

.field protected JJ:Landroid/view/LayoutInflater;

.field private JK:I

.field private JL:I

.field public JM:Landroid/support/v7/view/menu/m;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    .line 58
    iput-object p1, p0, Landroid/support/v7/view/menu/b;->JI:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->JJ:Landroid/view/LayoutInflater;

    .line 60
    iput p2, p0, Landroid/support/v7/view/menu/b;->JK:I

    .line 61
    iput p3, p0, Landroid/support/v7/view/menu/b;->JL:I
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 180
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->JJ:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/view/menu/b;->JL:I
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/f;)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->CJ:Landroid/view/LayoutInflater;

    .line 68
    iput-object p2, p0, Landroid/support/v7/view/menu/b;->dn:Landroid/support/v7/view/menu/f;
...
.method public a(Landroid/support/v7/view/menu/f;Z)V
    ...
    .prologue
    .line 206
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->dm:Landroid/support/v7/view/menu/l$a;
...
.method public c(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/m;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->JM:Landroid/support/v7/view/menu/m;
    ...
    iget v1, p0, Landroid/support/v7/view/menu/b;->JK:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->JM:Landroid/support/v7/view/menu/m;

    .line 75
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->JM:Landroid/support/v7/view/menu/m;

    iget-object v1, p0, Landroid/support/v7/view/menu/b;->dn:Landroid/support/v7/view/menu/f;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/view/menu/b;->f(Z)V
...
.method public f(Z)V
    ...
    invoke-interface {v2}, Landroid/support/v7/view/menu/m$a;->z()Landroid/support/v7/view/menu/h;
    ...
    .line 104
    invoke-static {v9}, Landroid/support/v4/view/z;->ab(Landroid/view/View;)V
    ...
    :cond_3
    iget-object v1, p0, Landroid/support/v7/view/menu/b;->JM:Landroid/support/v7/view/menu/m;
