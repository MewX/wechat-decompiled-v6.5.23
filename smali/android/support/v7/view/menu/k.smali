...
.field public KD:Landroid/support/v7/view/menu/l$a;

.field private final KY:Landroid/support/v7/view/menu/k$a;
...
.field public Ld:Landroid/support/v7/widget/ListPopupWindow;
...
.field public final dn:Landroid/support/v7/view/menu/f;

.field public gO:Landroid/view/View;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroid/support/v7/view/menu/k;->KX:I
...
.method private constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/f;Landroid/view/View;ZIB)V
    ...
    .line 77
    iput v2, p0, Landroid/support/v7/view/menu/k;->Li:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->CJ:Landroid/view/LayoutInflater;

    .line 96
    iput-object p2, p0, Landroid/support/v7/view/menu/k;->dn:Landroid/support/v7/view/menu/f;

    .line 97
    new-instance v0, Landroid/support/v7/view/menu/k$a;

    iget-object v1, p0, Landroid/support/v7/view/menu/k;->dn:Landroid/support/v7/view/menu/f;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->KY:Landroid/support/v7/view/menu/k$a;

    .line 98
    iput-boolean p4, p0, Landroid/support/v7/view/menu/k;->KZ:Z

    .line 99
    iput p5, p0, Landroid/support/v7/view/menu/k;->Lb:I

    .line 100
    iput v2, p0, Landroid/support/v7/view/menu/k;->Lc:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/k;->La:I

    .line 106
    iput-object p3, p0, Landroid/support/v7/view/menu/k;->gO:Landroid/view/View;
...
.method public final a(Landroid/support/v7/view/menu/f;Z)V
    ...
    .prologue
    .line 304
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->dn:Landroid/support/v7/view/menu/f;
    ...
    .line 307
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->KD:Landroid/support/v7/view/menu/l$a;
...
.method public final a(Landroid/support/v7/view/menu/p;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/k;->gO:Landroid/view/View;
    ...
    iput-object v0, v3, Landroid/support/v7/view/menu/k;->KD:Landroid/support/v7/view/menu/l$a;
    ...
    .line 289
    :goto_1
    iput-boolean v0, v3, Landroid/support/v7/view/menu/k;->JY:Z

    .line 291
    invoke-virtual {v3}, Landroid/support/v7/view/menu/k;->dK()Z
...
.method public final dK()Z
    ...
    iget v5, p0, Landroid/support/v7/view/menu/k;->Lb:I

    iget v6, p0, Landroid/support/v7/view/menu/k;->Lc:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->Ld:Landroid/support/v7/widget/ListPopupWindow;

    .line 140
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Ld:Landroid/support/v7/widget/ListPopupWindow;
    ...
    iput-object p0, v0, Landroid/support/v7/widget/ListPopupWindow;->RZ:Landroid/widget/AdapterView$OnItemClickListener;

    .line 142
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Ld:Landroid/support/v7/widget/ListPopupWindow;

    iget-object v3, p0, Landroid/support/v7/view/menu/k;->KY:Landroid/support/v7/view/menu/k$a;
    ...
    .line 145
    iget-object v3, p0, Landroid/support/v7/view/menu/k;->gO:Landroid/view/View;

    .line 146
    if-eqz v3, :cond_5

    .line 147
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Le:Landroid/view/ViewTreeObserver;
    ...
    iput-object v5, p0, Landroid/support/v7/view/menu/k;->Le:Landroid/view/ViewTreeObserver;
    ...
    iput-object v3, v0, Landroid/support/v7/widget/ListPopupWindow;->RX:Landroid/view/View;

    .line 151
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Ld:Landroid/support/v7/widget/ListPopupWindow;

    iget v3, p0, Landroid/support/v7/view/menu/k;->Li:I

    iput v3, v0, Landroid/support/v7/widget/ListPopupWindow;->Li:I

    .line 156
    iget-boolean v0, p0, Landroid/support/v7/view/menu/k;->Lg:Z

    if-nez v0, :cond_3

    .line 157
    iget-object v7, p0, Landroid/support/v7/view/menu/k;->KY:Landroid/support/v7/view/menu/k$a;
    ...
    :goto_2
    iget-object v5, p0, Landroid/support/v7/view/menu/k;->Lf:Landroid/view/ViewGroup;
    ...
    iput-object v5, p0, Landroid/support/v7/view/menu/k;->Lf:Landroid/view/ViewGroup;
    ...
    iget v11, p0, Landroid/support/v7/view/menu/k;->La:I

    if-lt v0, v11, :cond_6

    iget v2, p0, Landroid/support/v7/view/menu/k;->La:I

    :cond_2
    iput v2, p0, Landroid/support/v7/view/menu/k;->Lh:I

    .line 158
    iput-boolean v1, p0, Landroid/support/v7/view/menu/k;->Lg:Z

    .line 161
    :cond_3
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Ld:Landroid/support/v7/widget/ListPopupWindow;

    iget v2, p0, Landroid/support/v7/view/menu/k;->Lh:I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ListPopupWindow;->fd()V
...
.method public final f(Z)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/k;->Lg:Z

    .line 264
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->KY:Landroid/support/v7/view/menu/k$a;
...
.method public onDismiss()V
    ...
    .line 175
    iput-object v1, p0, Landroid/support/v7/view/menu/k;->Ld:Landroid/support/v7/widget/ListPopupWindow;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->gO:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/k;->Le:Landroid/view/ViewTreeObserver;
    ...
    .line 180
    iput-object v1, p0, Landroid/support/v7/view/menu/k;->Le:Landroid/view/ViewTreeObserver;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/view/menu/k$a;->ax(I)Landroid/support/v7/view/menu/h;
