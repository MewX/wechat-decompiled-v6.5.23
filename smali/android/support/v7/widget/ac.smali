...
# instance fields
.field final Ub:Landroid/support/v7/widget/RecyclerView;

.field final Vj:Landroid/support/v4/view/a;
...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ac;->Vj:Landroid/support/v4/view/a;

    .line 35
    iput-object p1, p0, Landroid/support/v7/widget/ac;->Ub:Landroid/support/v7/widget/RecyclerView;
...
.method public final a(Landroid/view/View;Landroid/support/v4/view/a/b;)V
    ...
    .line 58
    invoke-virtual {p0}, Landroid/support/v7/widget/ac;->ga()Z

    move-result v0

    if-nez v0, :cond_4

    iget-object v0, p0, Landroid/support/v7/widget/ac;->Ub:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->SO:Landroid/support/v7/widget/RecyclerView$m;

    iget-object v2, v0, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->TC:Landroid/support/v7/widget/RecyclerView$q;

    iget-object v3, v0, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;
    ...
    sget-object v2, Landroid/support/v4/view/a/b;->yZ:Landroid/support/v4/view/a/b$e;
    ...
    sget-object v1, Landroid/support/v4/view/a/b;->yZ:Landroid/support/v4/view/a/b$e;

    iget-object v2, p2, Landroid/support/v4/view/a/b;->za:Ljava/lang/Object;

    check-cast v0, Landroid/support/v4/view/a/b$k;

    iget-object v0, v0, Landroid/support/v4/view/a/b$k;->za:Ljava/lang/Object;

    invoke-interface {v1, v2, v0}, Landroid/support/v4/view/a/b$e;->h(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final ga()Z
    ...
    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView;->Td:Z

    if-eqz v1, :cond_0

    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView;->Tm:Z
...
.method public final performAccessibilityAction(Landroid/view/View;ILandroid/os/Bundle;)Z
    ...
    iget-object v4, v0, Landroid/support/v7/widget/RecyclerView;->SW:Landroid/support/v7/widget/RecyclerView$h;

    iget-object v0, v4, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;
    ...
    :cond_2
    iget-object v1, v4, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;
    ...
    :goto_2
    iget-object v3, v4, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;
