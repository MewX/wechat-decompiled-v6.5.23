...
.field final synthetic OY:Landroid/support/v7/widget/AppCompatSpinner;

.field Pb:Ljava/lang/CharSequence;

.field final Pc:Landroid/graphics/Rect;
...
.method public constructor <init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .prologue
    .line 701
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->OY:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->Pc:Landroid/graphics/Rect;

    .line 704
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->RX:Landroid/view/View;
    ...
    iput v0, p0, Landroid/support/v7/widget/ListPopupWindow;->RW:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->RZ:Landroid/widget/AdapterView$OnItemClickListener;
...
.method final ez()V
    ...
    .line 740
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->OY:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/at;->bw(Landroid/view/View;)Z
    ...
    .line 751
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->OY:Landroid/support/v7/widget/AppCompatSpinner;

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->EP:Landroid/widget/ListAdapter;

    check-cast v0, Landroid/widget/SpinnerAdapter;

    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->RL:Landroid/widget/PopupWindow;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->OY:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iget v2, p0, Landroid/support/v7/widget/ListPopupWindow;->OW:I
    ...
    .line 770
    :goto_4
    iput v0, p0, Landroid/support/v7/widget/ListPopupWindow;->RO:I
    ...
    .line 744
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->OY:Landroid/support/v7/widget/AppCompatSpinner;
...
.method public final setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 724
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->EP:Landroid/widget/ListAdapter;
...
.method public final show()V
    ...
    .line 776
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$b;->ez()V

    .line 778
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$b;->fd()V

    .line 779
    invoke-super {p0}, Landroid/support/v7/widget/ListPopupWindow;->show()V

    .line 780
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->RM:Landroid/support/v7/widget/ListPopupWindow$a;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->RM:Landroid/support/v7/widget/ListPopupWindow$a;
