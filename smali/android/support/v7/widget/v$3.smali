...
.method constructor <init>(Landroid/support/v7/widget/v;Ljava/util/ArrayList;)V
    ...
    .prologue
    .line 164
    iput-object p1, p0, Landroid/support/v7/widget/v$3;->Qb:Landroid/support/v7/widget/v;

    iput-object p2, p0, Landroid/support/v7/widget/v$3;->Qd:Ljava/util/ArrayList;
...
.method public final run()V
    ...
    .prologue
    .line 166
    iget-object v0, p0, Landroid/support/v7/widget/v$3;->Qd:Ljava/util/ArrayList;
    ...
    .line 167
    iget-object v2, p0, Landroid/support/v7/widget/v$3;->Qb:Landroid/support/v7/widget/v;
    ...
    iget-object v4, v2, Landroid/support/v7/widget/v;->PW:Ljava/util/ArrayList;

    invoke-virtual {v4, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-virtual {v3, v4}, Landroid/support/v4/view/ai;->p(F)Landroid/support/v4/view/ai;

    move-result-object v4

    iget-wide v6, v2, Landroid/support/v7/widget/RecyclerView$e;->TW:J
    ...
    .line 170
    iget-object v0, p0, Landroid/support/v7/widget/v$3;->Qb:Landroid/support/v7/widget/v;

    iget-object v0, v0, Landroid/support/v7/widget/v;->PT:Ljava/util/ArrayList;

    iget-object v1, p0, Landroid/support/v7/widget/v$3;->Qd:Ljava/util/ArrayList;
