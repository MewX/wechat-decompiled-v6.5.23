...
# static fields
.field private static final OQ:Z

.field private static final OR:Z

.field private static final OS:[I


# instance fields
.field private JA:Landroid/support/v7/widget/ListPopupWindow$b;

.field private Lo:Landroid/content/Context;

.field private OT:Landroid/widget/SpinnerAdapter;

.field private OU:Z

.field private OV:Landroid/support/v7/widget/AppCompatSpinner$b;

.field private OW:I

.field private Oc:Landroid/support/v7/widget/h;

.field private Od:Landroid/support/v7/widget/f;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v7/widget/AppCompatSpinner;->OQ:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/support/v7/widget/AppCompatSpinner;->OR:Z
    ...
    sput-object v0, Landroid/support/v7/widget/AppCompatSpinner;->OS:[I
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->dF:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->Oc:Landroid/support/v7/widget/h;

    .line 202
    new-instance v0, Landroid/support/v7/widget/f;

    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->Oc:Landroid/support/v7/widget/h;

    invoke-direct {v0, p0, v2}, Landroid/support/v7/widget/f;-><init>(Landroid/view/View;Landroid/support/v7/widget/h;)V

    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->Od:Landroid/support/v7/widget/f;

    .line 204
    sget v0, Landroid/support/v7/a/a$k;->Spinner_popupTheme:I

    invoke-virtual {v4, v0, v5}, Landroid/support/v7/widget/ap;->getResourceId(II)I
    ...
    .line 213
    :goto_0
    iput-object v0, v2, Landroid/support/v7/widget/AppCompatSpinner;->Lo:Landroid/content/Context;

    .line 217
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->Lo:Landroid/content/Context;
    ...
    .line 223
    :try_start_0
    sget-object v0, Landroid/support/v7/widget/AppCompatSpinner;->OS:[I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->Lo:Landroid/content/Context;
    ...
    invoke-static {v2, p2, v5, p3}, Landroid/support/v7/widget/ap;->a(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroid/support/v7/widget/ap;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/ap;->getLayoutDimension(II)I

    move-result v5

    iput v5, p0, Landroid/support/v7/widget/AppCompatSpinner;->OW:I

    .line 247
    sget v5, Landroid/support/v7/a/a$k;->Spinner_android_popupBackground:I

    invoke-virtual {v2, v5}, Landroid/support/v7/widget/ap;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, v4, Landroid/support/v7/widget/ap;->Yu:Landroid/content/res/TypedArray;

    invoke-virtual {v6, v5}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v5

    iput-object v5, v0, Landroid/support/v7/widget/AppCompatSpinner$b;->Pb:Ljava/lang/CharSequence;

    .line 250
    iget-object v2, v2, Landroid/support/v7/widget/ap;->Yu:Landroid/content/res/TypedArray;

    invoke-virtual {v2}, Landroid/content/res/TypedArray;->recycle()V

    .line 252
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->OV:Landroid/support/v7/widget/AppCompatSpinner$b;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->JA:Landroid/support/v7/widget/ListPopupWindow$b;

    .line 270
    :cond_2
    sget v0, Landroid/support/v7/a/a$k;->Spinner_android_entries:I

    iget-object v2, v4, Landroid/support/v7/widget/ap;->Yu:Landroid/content/res/TypedArray;
    ...
    .line 278
    :cond_3
    iget-object v0, v4, Landroid/support/v7/widget/ap;->Yu:Landroid/content/res/TypedArray;

    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    .line 280
    iput-boolean v3, p0, Landroid/support/v7/widget/AppCompatSpinner;->OU:Z

    .line 284
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->OT:Landroid/widget/SpinnerAdapter;
    ...
    .line 286
    iput-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->OT:Landroid/widget/SpinnerAdapter;

    .line 289
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->Od:Landroid/support/v7/widget/f;
    ...
    .line 213
    :cond_5
    sget-boolean v0, Landroid/support/v7/widget/AppCompatSpinner;->OQ:Z
...
.method private a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    .line 572
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->dF:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->dF:Landroid/graphics/Rect;
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner;)Landroid/support/v7/widget/AppCompatSpinner$b;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->OV:Landroid/support/v7/widget/AppCompatSpinner$b;
...
.method static synthetic c(Landroid/support/v7/widget/AppCompatSpinner;)I
    ...
    .prologue
    .line 64
    iget v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->OW:I
...
.method public final bK()Landroid/content/res/ColorStateList;
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/f;->bK()Landroid/content/res/ColorStateList;
...
.method public final bL()Landroid/graphics/PorterDuff$Mode;
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/f;->bL()Landroid/graphics/PorterDuff$Mode;
...
.method protected drawableStateChanged()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/f;->eu()V
...
.method public getDropDownHorizontalOffset()I
    ...
    iget v0, v0, Landroid/support/v7/widget/ListPopupWindow;->RO:I
    ...
    .line 359
    :cond_0
    sget-boolean v0, Landroid/support/v7/widget/AppCompatSpinner;->OR:Z
...
.method public getDropDownVerticalOffset()I
    ...
    .line 334
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner;->OV:Landroid/support/v7/widget/AppCompatSpinner$b;
    ...
    iget-boolean v2, v1, Landroid/support/v7/widget/ListPopupWindow;->RR:Z
    ...
    .line 335
    :cond_1
    iget v0, v1, Landroid/support/v7/widget/ListPopupWindow;->RP:I

    goto :goto_0

    .line 336
    :cond_2
    sget-boolean v1, Landroid/support/v7/widget/AppCompatSpinner;->OR:Z
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/AppCompatSpinner$b;->Pb:Ljava/lang/CharSequence;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 410
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->JA:Landroid/support/v7/widget/ListPopupWindow$b;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .prologue
    .line 386
    iget-boolean v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->OU:Z

    if-nez v0, :cond_1

    .line 387
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->OT:Landroid/widget/SpinnerAdapter;
...
.method public setBackgroundResource(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/f;->aK(I)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    iput p1, v0, Landroid/support/v7/widget/ListPopupWindow;->RO:I
...
.method public setDropDownWidth(I)V
    ...
    .line 367
    iput p1, p0, Landroid/support/v7/widget/AppCompatSpinner;->OW:I
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, v0, Landroid/support/v7/widget/AppCompatSpinner$b;->Pb:Ljava/lang/CharSequence;
