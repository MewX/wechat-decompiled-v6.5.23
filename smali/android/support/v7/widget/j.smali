...
# instance fields
.field private final OK:Landroid/widget/ProgressBar;

.field OL:Landroid/graphics/Bitmap;

.field final Oc:Landroid/support/v7/widget/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/j;->JQ:[I
...
.method constructor <init>(Landroid/widget/ProgressBar;Landroid/support/v7/widget/h;)V
    ...
    .line 48
    iput-object p1, p0, Landroid/support/v7/widget/j;->OK:Landroid/widget/ProgressBar;

    .line 49
    iput-object p2, p0, Landroid/support/v7/widget/j;->Oc:Landroid/support/v7/widget/h;
...
.method private b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Landroid/support/v4/b/a/c;->bp()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/b/a/c;->j(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 101
    iget-object v0, p0, Landroid/support/v7/widget/j;->OL:Landroid/graphics/Bitmap;

    if-nez v0, :cond_7

    .line 102
    iput-object v1, p0, Landroid/support/v7/widget/j;->OL:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 53
    iget-object v0, p0, Landroid/support/v7/widget/j;->OK:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroid/support/v7/widget/j;->JQ:[I
    ...
    .line 56
    invoke-virtual {v4, v3}, Landroid/support/v7/widget/ap;->bG(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 58
    iget-object v5, p0, Landroid/support/v7/widget/j;->OK:Landroid/widget/ProgressBar;
    ...
    .line 61
    :cond_2
    invoke-virtual {v4, v9}, Landroid/support/v7/widget/ap;->bG(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 63
    iget-object v1, p0, Landroid/support/v7/widget/j;->OK:Landroid/widget/ProgressBar;
