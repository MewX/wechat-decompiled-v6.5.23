...
.field private Sl:Landroid/support/v4/view/ai;

.field private Sm:Landroid/support/v4/widget/k;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 1585
    iput-boolean p2, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sj:Z
...
.method static synthetic a(Landroid/support/v7/widget/ListPopupWindow$a;Z)Z
    ...
    .prologue
    .line 1532
    iput-boolean p1, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Si:Z
...
# virtual methods
.method protected final fe()Z
    .locals 1

    .prologue
    .line 1726
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sk:Z

    if-nez v0, :cond_0

    invoke-super {p0}, Landroid/support/v7/widget/ListViewCompat;->fe()Z
...
.method public final h(Landroid/view/MotionEvent;I)Z
    ...
    .line 1634
    :cond_1
    iput-boolean v1, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sk:Z
    ...
    iget v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->SD:I
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sl:Landroid/support/v4/view/ai;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sl:Landroid/support/v4/view/ai;
    ...
    .line 1639
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sm:Landroid/support/v4/widget/k;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sm:Landroid/support/v4/widget/k;

    .line 1642
    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sm:Landroid/support/v4/widget/k;

    invoke-virtual {v0, v2}, Landroid/support/v4/widget/k;->s(Z)Landroid/support/v4/widget/a;
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sk:Z
    ...
    :cond_a
    iput v6, p0, Landroid/support/v7/widget/ListPopupWindow$a;->SD:I
    ...
    :cond_f
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/ListPopupWindow$a;->Q(Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/k;->s(Z)Landroid/support/v4/widget/a;
...
.method public final hasFocus()Z
    ...
    .prologue
    .line 1762
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Sj:Z
...
.method public final isInTouchMode()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ListPopupWindow$a;->Si:Z
