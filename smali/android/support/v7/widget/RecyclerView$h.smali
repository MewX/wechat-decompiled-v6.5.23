...
.field Uc:Landroid/support/v7/widget/RecyclerView$p;
...
.method public constructor <init>()V
    ...
    .line 5979
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Ud:Z

    .line 5981
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->gx:Z

    .line 5983
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Ue:Z

    .line 5989
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Uf:Z
...
.method private bf(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->SR:Landroid/support/v7/widget/s;
...
.method private removeViewAt(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/s;->aM(I)I

    move-result v1

    iget-object v2, v0, Landroid/support/v7/widget/s;->PC:Landroid/support/v7/widget/s$b;
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/s$a;->aO(I)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/s;->aO(Landroid/view/View;)Z

    :cond_0
    iget-object v0, v0, Landroid/support/v7/widget/s;->PC:Landroid/support/v7/widget/s$b;
...
.method final Y(II)V
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Ug:I

    .line 6025
    iget v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Ug:I

    if-nez v0, :cond_0

    sget-boolean v0, Landroid/support/v7/widget/RecyclerView;->SL:Z
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Uh:I

    .line 6031
    iget v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Uh:I
...
.method final Z(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/RecyclerView;->N(II)V
    ...
    .line 6066
    invoke-static {v10}, Landroid/support/v7/widget/RecyclerView$h;->bl(Landroid/view/View;)I
...
.method public final a(ILandroid/support/v7/widget/RecyclerView$m;)V
    ...
    .line 7039
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/RecyclerView$m;->bn(Landroid/view/View;)V
...
.method public a(Landroid/graphics/Rect;II)V
    ...
    invoke-static {p2, v0, v2}, Landroid/support/v7/widget/RecyclerView$h;->i(III)I
    ...
    invoke-static {p3, v1, v2}, Landroid/support/v7/widget/RecyclerView$h;->i(III)I
...
.method public a(Landroid/support/v7/widget/RecyclerView$m;Landroid/support/v7/widget/RecyclerView$q;Landroid/view/View;Landroid/support/v4/view/a/b;)V
    ...
    invoke-static {p3}, Landroid/support/v7/widget/RecyclerView$h;->be(Landroid/view/View;)I
...
.method public final a(Landroid/support/v7/widget/RecyclerView$p;)V
    ...
    .line 6591
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Uc:Landroid/support/v7/widget/RecyclerView$p;
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/RecyclerView$p;->mRunning:Z
    ...
    .line 6595
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$h;->Uc:Landroid/support/v7/widget/RecyclerView$p;
    ...
    iput-object v1, v0, Landroid/support/v7/widget/RecyclerView$p;->Ub:Landroid/support/v7/widget/RecyclerView;

    iput-object p0, v0, Landroid/support/v7/widget/RecyclerView$p;->SH:Landroid/support/v7/widget/RecyclerView$h;

    iget v1, v0, Landroid/support/v7/widget/RecyclerView$p;->Uw:I
    ...
    :cond_1
    iget-object v1, v0, Landroid/support/v7/widget/RecyclerView$p;->Ub:Landroid/support/v7/widget/RecyclerView;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->TC:Landroid/support/v7/widget/RecyclerView$q;

    iget v2, v0, Landroid/support/v7/widget/RecyclerView$p;->Uw:I

    iput v2, v1, Landroid/support/v7/widget/RecyclerView$q;->Uw:I

    iput-boolean v3, v0, Landroid/support/v7/widget/RecyclerView$p;->mRunning:Z

    iput-boolean v3, v0, Landroid/support/v7/widget/RecyclerView$p;->Ux:Z

    iget v1, v0, Landroid/support/v7/widget/RecyclerView$p;->Uw:I

    iget-object v2, v0, Landroid/support/v7/widget/RecyclerView$p;->Ub:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->SW:Landroid/support/v7/widget/RecyclerView$h;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/RecyclerView$h;->aV(I)Landroid/view/View;

    move-result-object v1

    iput-object v1, v0, Landroid/support/v7/widget/RecyclerView$p;->Uy:Landroid/view/View;

    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView$p;->Ub:Landroid/support/v7/widget/RecyclerView;
...
.method public final a(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/RecyclerView;->bc(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public final a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$m;)V
    ...
    iget-object v2, v0, Landroid/support/v7/widget/s;->PD:Landroid/support/v7/widget/s$a;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/s$a;->aO(I)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {v0, p1}, Landroid/support/v7/widget/s;->aO(Landroid/view/View;)Z
    ...
    .line 7027
    :cond_1
    invoke-virtual {p2, p1}, Landroid/support/v7/widget/RecyclerView$m;->bn(Landroid/view/View;)V
...
.method final a(Landroid/view/View;IILandroid/support/v7/widget/RecyclerView$LayoutParams;)Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Uf:Z
    ...
    invoke-static {v0, p2, v1}, Landroid/support/v7/widget/RecyclerView$h;->j(III)Z
    ...
    invoke-static {v0, p3, v1}, Landroid/support/v7/widget/RecyclerView$h;->j(III)Z
...
.method public final b(Landroid/support/v7/widget/RecyclerView$m;)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$t;->ga()Z

    move-result v3

    if-nez v3, :cond_0

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$t;->gj()Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 7298
    :cond_1
    invoke-direct {p0, v0}, Landroid/support/v7/widget/RecyclerView$h;->bf(I)V

    invoke-virtual {p1, v1}, Landroid/support/v7/widget/RecyclerView$m;->bp(Landroid/view/View;)V

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->SS:Landroid/support/v7/widget/as;

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/as;->w(Landroid/support/v7/widget/RecyclerView$t;)V
...
.method final b(Landroid/view/View;Landroid/support/v4/view/a/b;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->SO:Landroid/support/v7/widget/RecyclerView$m;
...
.method public final bf(Landroid/view/View;)Landroid/view/View;
    .locals 6
    ...
    .line 6837
    :cond_4
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView$h;->SR:Landroid/support/v7/widget/s;

    invoke-virtual {v2, v0}, Landroid/support/v7/widget/s;->aP(Landroid/view/View;)Z
...
.method public bg(I)V
    ...
    iget-object v0, v1, Landroid/support/v7/widget/RecyclerView;->SR:Landroid/support/v7/widget/s;
    ...
    iget-object v3, v1, Landroid/support/v7/widget/RecyclerView;->SR:Landroid/support/v7/widget/s;
...
.method final c(Landroid/support/v7/widget/RecyclerView$m;)V
    ...
    .line 7331
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$m;->Uo:Ljava/util/ArrayList;
    ...
    .line 7337
    invoke-virtual {v3, v5}, Landroid/support/v7/widget/RecyclerView$t;->U(Z)V

    .line 7345
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$t;->gl()Z
    ...
    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->Ts:Landroid/support/v7/widget/RecyclerView$e;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v7/widget/RecyclerView$t;->U(Z)V

    .line 7352
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/RecyclerView$m;->bo(Landroid/view/View;)V
    ...
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$m;->Up:Ljava/util/ArrayList;
...
.method c(Landroid/view/View;IZ)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/as;->v(Landroid/support/v7/widget/RecyclerView$t;)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$t;->ge()Z
    ...
    .line 6705
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$t;->gf()V
    ...
    :cond_2
    :goto_2
    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Uk:Z
    ...
    .line 6739
    iput-boolean v7, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Uk:Z
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/as;->w(Landroid/support/v7/widget/RecyclerView$t;)V
    ...
    .line 6717
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$h;->SR:Landroid/support/v7/widget/s;
    ...
    :cond_9
    invoke-direct {v3, v1}, Landroid/support/v7/widget/RecyclerView$h;->bf(I)V
    ...
    iget-object v6, v3, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;

    iget-object v6, v6, Landroid/support/v7/widget/RecyclerView;->SS:Landroid/support/v7/widget/as;

    invoke-virtual {v6, v5}, Landroid/support/v7/widget/as;->v(Landroid/support/v7/widget/RecyclerView$t;)V

    :goto_3
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView$h;->SR:Landroid/support/v7/widget/s;
    ...
    invoke-virtual {v6, v5}, Landroid/support/v7/widget/as;->w(Landroid/support/v7/widget/RecyclerView$t;)V
    ...
    .line 6730
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Uc:Landroid/support/v7/widget/RecyclerView$p;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Uc:Landroid/support/v7/widget/RecyclerView$p;

    iget-boolean v1, v1, Landroid/support/v7/widget/RecyclerView$p;->mRunning:Z
    ...
    invoke-static {p1}, Landroid/support/v7/widget/RecyclerView;->bb(Landroid/view/View;)I

    move-result v3

    iget v4, v1, Landroid/support/v7/widget/RecyclerView$p;->Uw:I

    if-ne v3, v4, :cond_2

    iput-object p1, v1, Landroid/support/v7/widget/RecyclerView$p;->Uy:Landroid/view/View;
...
.method public final d(Landroid/support/v7/widget/RecyclerView$m;)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$t;->ga()Z
...
.method public abstract eM()Landroid/support/v7/widget/RecyclerView$LayoutParams;
.end method
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->SO:Landroid/support/v7/widget/RecyclerView$m;
...
.method final y(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 6008
    iput-object v2, p0, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;

    .line 6009
    iput-object v2, p0, Landroid/support/v7/widget/RecyclerView$h;->SR:Landroid/support/v7/widget/s;
    ...
    .line 6018
    :goto_0
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Ug:I

    .line 6019
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Uh:I
    ...
    .line 6013
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$h;->Ub:Landroid/support/v7/widget/RecyclerView;

    .line 6014
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->SR:Landroid/support/v7/widget/s;

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->SR:Landroid/support/v7/widget/s;
...
.method final z(Landroid/support/v7/widget/RecyclerView;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->Y(II)V
