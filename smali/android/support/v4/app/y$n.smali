.class final Landroid/support/v4/app/y$n;
...
.method public final b(Landroid/support/v4/app/y$d;)Landroid/app/Notification;
    ...
    .prologue
    .line 569
    iget-object v0, p1, Landroid/support/v4/app/y$d;->mContext:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/y$d;->rC:Landroid/app/Notification;

    iget-object v2, p1, Landroid/support/v4/app/y$d;->re:Ljava/lang/CharSequence;

    iget-object v3, p1, Landroid/support/v4/app/y$d;->rf:Ljava/lang/CharSequence;

    iget-object v4, p1, Landroid/support/v4/app/y$d;->rk:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/y$d;->ri:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/y$d;->rl:I

    iget-object v7, p1, Landroid/support/v4/app/y$d;->rg:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/y$d;->rh:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/y$d;->rj:Landroid/graphics/Bitmap;
