...
.method final a(Landroid/support/design/widget/l$a;Z)V
    ...
    .line 46
    iget-boolean v0, p0, Landroid/support/design/widget/k;->hr:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/k;->hH:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    invoke-virtual {v0, v1, v4}, Landroid/support/design/widget/VisibilityAwareImageButton;->a(IZ)V
...
.method final aa()V
    ...
    iget-object v1, p0, Landroid/support/design/widget/k;->hs:Landroid/support/design/widget/o;
    ...
    iget v3, v1, Landroid/support/design/widget/o;->eS:F

    cmpl-float v3, v3, v2

    if-eqz v3, :cond_0

    iput v2, v1, Landroid/support/design/widget/o;->eS:F

    invoke-virtual {v1}, Landroid/support/design/widget/o;->invalidateSelf()V

    :cond_0
    iget-object v1, p0, Landroid/support/design/widget/k;->hC:Landroid/support/design/widget/d;
    ...
    iget v2, v1, Landroid/support/design/widget/d;->eS:F

    cmpl-float v2, v0, v2

    if-eqz v2, :cond_1

    iput v0, v1, Landroid/support/design/widget/d;->eS:F
...
.method final b(Landroid/support/design/widget/l$a;Z)V
    ...
    invoke-virtual {v0, v4, v4}, Landroid/support/design/widget/VisibilityAwareImageButton;->a(IZ)V
