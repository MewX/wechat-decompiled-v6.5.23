...
.field private ec:Ljava/lang/ref/WeakReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private ed:Landroid/support/design/widget/AppBarLayout$Behavior$a;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dZ:I
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    .line 854
    invoke-virtual {p0}, Landroid/support/design/widget/AppBarLayout$Behavior;->H()I
    ...
    .line 858
    iget v1, v0, Landroid/support/design/widget/AppBarLayout$LayoutParams;->ek:I
    ...
    .line 864
    iget v0, v0, Landroid/support/design/widget/AppBarLayout$LayoutParams;->ek:I
    ...
    .line 866
    invoke-static {v3}, Landroid/support/v4/view/z;->U(Landroid/view/View;)I
    ...
    invoke-static {v0, v1, v4}, Landroid/support/design/widget/n;->b(III)I
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)V
    ...
    .line 814
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dY:Landroid/support/design/widget/u;
    ...
    .line 820
    :cond_1
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dY:Landroid/support/design/widget/u;
    ...
    iput-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dY:Landroid/support/design/widget/u;

    .line 822
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dY:Landroid/support/design/widget/u;

    sget-object v2, Landroid/support/design/widget/a;->dL:Landroid/view/animation/Interpolator;
    ...
    .line 837
    iget-object v2, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dY:Landroid/support/design/widget/u;
    ...
    invoke-virtual {v1, v0, p3}, Landroid/support/design/widget/u;->e(II)V
...
.method private j(Landroid/support/design/widget/AppBarLayout;)V
    ...
    .line 1031
    invoke-super {p0}, Landroid/support/design/widget/HeaderBehavior;->I()I
...
.method final H()I
    ...
    iget v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dV:I
...
.method final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-static {p3, p4, p5}, Landroid/support/design/widget/n;->b(III)I
    ...
    iget-object v8, v0, Landroid/support/design/widget/AppBarLayout$LayoutParams;->el:Landroid/view/animation/Interpolator;
    ...
    iget v3, v0, Landroid/support/design/widget/AppBarLayout$LayoutParams;->ek:I
    ...
    invoke-static {v7}, Landroid/support/v4/view/z;->U(Landroid/view/View;)I
    ...
    :cond_0
    :goto_1
    invoke-static {v7}, Landroid/support/v4/view/z;->aa(Landroid/view/View;)Z
    ...
    :goto_2
    invoke-super {p0, v0}, Landroid/support/design/widget/HeaderBehavior;->f(I)Z
    ...
    iput v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dV:I
    ...
    iget-object v0, p1, Landroid/support/design/widget/CoordinatorLayout;->gp:Ljava/util/List;
    ...
    iget-object v6, v1, Landroid/support/design/widget/CoordinatorLayout$d;->gJ:Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    :cond_9
    iput v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dV:I
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    iget v0, p3, Landroid/support/design/widget/AppBarLayout$Behavior$SavedState;->eh:I

    iput v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dZ:I

    iget v0, p3, Landroid/support/design/widget/AppBarLayout$Behavior$SavedState;->ei:F

    iput v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eb:F

    iget-boolean v0, p3, Landroid/support/design/widget/AppBarLayout$Behavior$SavedState;->ej:Z

    iput-boolean v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ea:Z
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)V
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dX:Z
    ...
    :cond_0
    iput-boolean v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dW:Z

    iput-boolean v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dX:Z

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p3}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ec:Ljava/lang/ref/WeakReference;
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I[I)V
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dW:Z
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;FZ)Z
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dX:Z
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-static {v0, v3, v1}, Landroid/support/design/widget/n;->b(III)I
    ...
    :cond_5
    iget v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dZ:I
    ...
    iget-boolean v4, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ea:Z

    if-eqz v4, :cond_6

    invoke-static {v0}, Landroid/support/v4/view/z;->U(Landroid/view/View;)I
    ...
    iget v4, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eb:F
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)Z
    ...
    iput-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ec:Ljava/lang/ref/WeakReference;
...
.method public final synthetic b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
    ...
    iput v3, v1, Landroid/support/design/widget/AppBarLayout$Behavior$SavedState;->eh:I

    invoke-static {v6}, Landroid/support/v4/view/z;->U(Landroid/view/View;)I
    ...
    :cond_0
    iput-boolean v0, v1, Landroid/support/design/widget/AppBarLayout$Behavior$SavedState;->ej:Z
    ...
    iput v0, v1, Landroid/support/design/widget/AppBarLayout$Behavior$SavedState;->ei:F
...
.method public final synthetic b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dW:Z

    :goto_0
    return-void

    :cond_0
    iput-boolean v5, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->dW:Z
...
.method final synthetic d(Landroid/view/View;)Z
    ...
    .prologue
    .line 652
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ed:Landroid/support/design/widget/AppBarLayout$Behavior$a;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ed:Landroid/support/design/widget/AppBarLayout$Behavior$a;

    invoke-virtual {v0}, Landroid/support/design/widget/AppBarLayout$Behavior$a;->J()Z
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ec:Ljava/lang/ref/WeakReference;
...
.method public final bridge synthetic f(I)Z
    .locals 1

    .prologue
    .line 652
    invoke-super {p0, p1}, Landroid/support/design/widget/HeaderBehavior;->f(I)Z
