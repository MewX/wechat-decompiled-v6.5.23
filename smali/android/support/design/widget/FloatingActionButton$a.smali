...
# static fields
.field private static final hj:Z


# instance fields
.field private fV:Landroid/graphics/Rect;

.field private hk:Landroid/support/design/widget/u;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/design/widget/FloatingActionButton$a;->hj:Z
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 489
    iget v0, v0, Landroid/support/design/widget/CoordinatorLayout$d;->gN:I
    ...
    .line 495
    :cond_0
    iget v0, p3, Landroid/support/design/widget/VisibilityAwareImageButton;->la:I
    ...
    .line 500
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton$a;->fV:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton$a;->fV:Landroid/graphics/Rect;
    ...
    invoke-static {p2}, Landroid/support/v4/view/z;->U(Landroid/view/View;)I
    ...
    invoke-static {v1}, Landroid/support/v4/view/z;->U(Landroid/view/View;)I
...
.method public final synthetic b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    iget-object v8, p1, Landroid/support/design/widget/CoordinatorLayout;->gs:Landroid/graphics/Rect;
    ...
    iget-object v9, p1, Landroid/support/design/widget/CoordinatorLayout;->gt:Landroid/graphics/Rect;
    ...
    :cond_4
    iget v0, p0, Landroid/support/design/widget/FloatingActionButton$a;->hl:F

    cmpl-float v0, v0, v4

    if-eqz v0, :cond_7

    invoke-static {p2}, Landroid/support/v4/view/z;->S(Landroid/view/View;)F

    move-result v0

    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton$a;->hk:Landroid/support/design/widget/u;
    ...
    iput-object v1, p0, Landroid/support/design/widget/FloatingActionButton$a;->hk:Landroid/support/design/widget/u;
    ...
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton$a;->hk:Landroid/support/design/widget/u;
    ...
    :goto_5
    iput v4, p0, Landroid/support/design/widget/FloatingActionButton$a;->hl:F
...
.method public final bridge synthetic e(Landroid/view/View;)Z
    ...
    .prologue
    .line 456
    sget-boolean v0, Landroid/support/design/widget/FloatingActionButton$a;->hj:Z
