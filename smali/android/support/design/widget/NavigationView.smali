...
# instance fields
.field private final hX:Landroid/support/design/internal/a;

.field private final hY:Landroid/support/design/internal/b;

.field private hZ:Landroid/support/design/widget/NavigationView$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/NavigationView;->dd:[I
    ...
    sput-object v0, Landroid/support/design/widget/NavigationView;->hW:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/NavigationView;->hY:Landroid/support/design/internal/b;
    ...
    iput-object v0, p0, Landroid/support/design/widget/NavigationView;->hX:Landroid/support/design/internal/a;

    .line 107
    sget-object v0, Landroid/support/design/a$i;->bV:[I

    sget v1, Landroid/support/design/a$h;->aR:I
    ...
    .line 113
    sget v0, Landroid/support/design/a$i;->bZ:I
    ...
    .line 120
    sget v0, Landroid/support/design/a$i;->bY:I

    invoke-virtual {v6, v0, v2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v0

    iput v0, p0, Landroid/support/design/widget/NavigationView;->ia:I

    .line 123
    sget v0, Landroid/support/design/a$i;->cc:I
    ...
    .line 131
    :goto_0
    sget v1, Landroid/support/design/a$i;->cd:I
    ...
    .line 137
    sget v7, Landroid/support/design/a$i;->ce:I
    ...
    .line 138
    sget v5, Landroid/support/design/a$i;->ce:I
    ...
    invoke-direct {p0, v5}, Landroid/support/design/widget/NavigationView;->v(I)Landroid/content/res/ColorStateList;

    move-result-object v5

    .line 146
    :cond_2
    sget v7, Landroid/support/design/a$i;->cb:I
    ...
    .line 148
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->hX:Landroid/support/design/internal/a;
    ...
    .line 157
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->hY:Landroid/support/design/internal/b;
    ...
    iget-object v9, p0, Landroid/support/design/widget/NavigationView;->hX:Landroid/support/design/internal/a;
    ...
    .line 161
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->hY:Landroid/support/design/internal/b;

    invoke-virtual {v0, v1}, Landroid/support/design/internal/b;->e(I)V
    ...
    .line 165
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->hX:Landroid/support/design/internal/a;

    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->hY:Landroid/support/design/internal/b;
    ...
    iget-object v0, v1, Landroid/support/design/internal/b;->dk:Landroid/support/design/internal/NavigationMenuView;

    if-nez v0, :cond_5

    iget-object v0, v1, Landroid/support/design/internal/b;->mLayoutInflater:Landroid/view/LayoutInflater;

    sget v3, Landroid/support/design/a$f;->aH:I
    ...
    iput-object v0, v1, Landroid/support/design/internal/b;->dk:Landroid/support/design/internal/NavigationMenuView;

    iget-object v0, v1, Landroid/support/design/internal/b;->do:Landroid/support/design/internal/b$b;
    ...
    iput-object v0, v1, Landroid/support/design/internal/b;->do:Landroid/support/design/internal/b$b;

    :cond_4
    iget-object v0, v1, Landroid/support/design/internal/b;->mLayoutInflater:Landroid/view/LayoutInflater;

    sget v3, Landroid/support/design/a$f;->aE:I

    iget-object v5, v1, Landroid/support/design/internal/b;->dk:Landroid/support/design/internal/NavigationMenuView;
    ...
    iput-object v0, v1, Landroid/support/design/internal/b;->dl:Landroid/widget/LinearLayout;

    iget-object v0, v1, Landroid/support/design/internal/b;->dk:Landroid/support/design/internal/NavigationMenuView;

    iget-object v3, v1, Landroid/support/design/internal/b;->do:Landroid/support/design/internal/b$b;
    ...
    invoke-virtual {v1, v4}, Landroid/support/design/internal/b;->g(Z)V

    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->ib:Landroid/view/MenuInflater;
    ...
    iput-object v1, p0, Landroid/support/design/widget/NavigationView;->ib:Landroid/view/MenuInflater;

    :cond_6
    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->ib:Landroid/view/MenuInflater;

    iget-object v3, p0, Landroid/support/design/widget/NavigationView;->hX:Landroid/support/design/internal/a;

    invoke-virtual {v1, v0, v3}, Landroid/view/MenuInflater;->inflate(ILandroid/view/Menu;)V

    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->hY:Landroid/support/design/internal/b;

    invoke-virtual {v0, v2}, Landroid/support/design/internal/b;->g(Z)V

    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->hY:Landroid/support/design/internal/b;

    invoke-virtual {v0, v2}, Landroid/support/design/internal/b;->f(Z)V

    .line 172
    :cond_7
    sget v0, Landroid/support/design/a$i;->ca:I
    ...
    iget-object v4, v1, Landroid/support/design/internal/b;->dl:Landroid/widget/LinearLayout;

    invoke-virtual {v3, v0, v4, v2}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    move-result-object v0

    iget-object v3, v1, Landroid/support/design/internal/b;->dl:Landroid/widget/LinearLayout;

    invoke-virtual {v3, v0}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, v1, Landroid/support/design/internal/b;->dk:Landroid/support/design/internal/NavigationMenuView;

    iget-object v1, v1, Landroid/support/design/internal/b;->dk:Landroid/support/design/internal/NavigationMenuView;
    ...
    invoke-direct {p0, v0}, Landroid/support/design/widget/NavigationView;->v(I)Landroid/content/res/ColorStateList;
...
.method static synthetic a(Landroid/support/design/widget/NavigationView;)Landroid/support/design/widget/NavigationView$a;
    ...
    .prologue
    .line 75
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->hZ:Landroid/support/design/widget/NavigationView$a;

    return-object v0
.end method

.method private v(I)Landroid/content/res/ColorStateList;
    .locals 10
    ...
    sget-object v5, Landroid/support/design/widget/NavigationView;->hW:[I

    aput-object v5, v4, v8

    sget-object v5, Landroid/support/design/widget/NavigationView;->dd:[I
    ...
    sget-object v6, Landroid/support/design/widget/NavigationView;->hW:[I
...
.method protected final a(Landroid/graphics/Rect;)V
    ...
    iget v2, v0, Landroid/support/design/internal/b;->dt:I

    if-eq v2, v1, :cond_0

    iput v1, v0, Landroid/support/design/internal/b;->dt:I

    iget-object v1, v0, Landroid/support/design/internal/b;->dl:Landroid/widget/LinearLayout;
    ...
    iget-object v1, v0, Landroid/support/design/internal/b;->dk:Landroid/support/design/internal/NavigationMenuView;

    iget v2, v0, Landroid/support/design/internal/b;->dt:I

    iget-object v0, v0, Landroid/support/design/internal/b;->dk:Landroid/support/design/internal/NavigationMenuView;
...
.method protected onMeasure(II)V
    ...
    iget v1, p0, Landroid/support/design/widget/NavigationView;->ia:I
    ...
    .line 219
    :sswitch_2
    iget v0, p0, Landroid/support/design/widget/NavigationView;->ia:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 196
    iget-object v2, p0, Landroid/support/design/widget/NavigationView;->hX:Landroid/support/design/internal/a;

    iget-object v0, p1, Landroid/support/design/widget/NavigationView$SavedState;->ie:Landroid/os/Bundle;
    ...
    iget-object v0, v2, Landroid/support/v7/view/menu/f;->Ky:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v1, v2, Landroid/support/v7/view/menu/f;->Ky:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v0, v1, Landroid/support/design/widget/NavigationView$SavedState;->ie:Landroid/os/Bundle;

    .line 184
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->hX:Landroid/support/design/internal/a;

    iget-object v2, v1, Landroid/support/design/widget/NavigationView$SavedState;->ie:Landroid/os/Bundle;
