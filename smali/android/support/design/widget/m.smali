...
# instance fields
.field private hL:Landroid/graphics/drawable/InsetDrawable;
...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/p;)V
    ...
    .line 46
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/m;->hH:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method final a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    .line 55
    invoke-static {}, Landroid/support/design/widget/m;->ad()Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/m;->hA:Landroid/graphics/drawable/Drawable;

    .line 56
    iget-object v0, p0, Landroid/support/design/widget/m;->hA:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/m;->hC:Landroid/support/design/widget/d;
    ...
    iget-object v3, p0, Landroid/support/design/widget/m;->hC:Landroid/support/design/widget/d;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    iget-object v3, p0, Landroid/support/design/widget/m;->hA:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/m;->hB:Landroid/graphics/drawable/Drawable;

    .line 73
    iget-object v0, p0, Landroid/support/design/widget/m;->hB:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, Landroid/support/design/widget/m;->hD:Landroid/graphics/drawable/Drawable;

    .line 75
    iget-object v0, p0, Landroid/support/design/widget/m;->hI:Landroid/support/design/widget/p;

    iget-object v1, p0, Landroid/support/design/widget/m;->hB:Landroid/graphics/drawable/Drawable;
    ...
    .line 66
    :cond_1
    iput-object v4, p0, Landroid/support/design/widget/m;->hC:Landroid/support/design/widget/d;
...
.method final ac()Landroid/support/design/widget/d;
    .locals 1
...
.method final b(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v0}, Landroid/support/design/widget/p;->W()Z
    ...
    invoke-interface {v0}, Landroid/support/design/widget/p;->V()F

    move-result v0

    .line 162
    iget-object v1, p0, Landroid/support/design/widget/m;->hH:Landroid/support/design/widget/VisibilityAwareImageButton;

    invoke-virtual {v1}, Landroid/support/design/widget/VisibilityAwareImageButton;->getElevation()F

    move-result v1

    iget v2, p0, Landroid/support/design/widget/m;->hF:F
...
.method final c(Landroid/graphics/Rect;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/m;->hL:Landroid/graphics/drawable/InsetDrawable;

    .line 128
    iget-object v0, p0, Landroid/support/design/widget/m;->hI:Landroid/support/design/widget/p;

    iget-object v1, p0, Landroid/support/design/widget/m;->hL:Landroid/graphics/drawable/InsetDrawable;
...
.method public final i(F)V
    ...
    .line 91
    invoke-virtual {p0}, Landroid/support/design/widget/m;->ab()V
...
.method final j(F)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/m;->hH:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 101
    sget-object v1, Landroid/support/design/widget/m;->hG:[I
