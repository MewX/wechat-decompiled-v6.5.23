...
# instance fields
.field final synthetic dv:Landroid/support/design/internal/b;
...
.field private dx:Landroid/support/v7/view/menu/h;

.field private dy:Landroid/graphics/drawable/ColorDrawable;
...
.method public constructor <init>(Landroid/support/design/internal/b;)V
    ...
    .prologue
    .line 343
    iput-object p1, p0, Landroid/support/design/internal/b$b;->dv:Landroid/support/design/internal/b;
    ...
    iput-object v0, p0, Landroid/support/design/internal/b$b;->dw:Ljava/util/ArrayList;

    .line 344
    invoke-virtual {p0}, Landroid/support/design/internal/b$b;->C()V
...
.method private b(II)V
    ...
    .line 517
    iget-object v0, p0, Landroid/support/design/internal/b$b;->dw:Ljava/util/ArrayList;
    ...
    .line 518
    iget-object v0, v0, Landroid/support/design/internal/b$f;->dC:Landroid/support/v7/view/menu/h;
    ...
    .line 520
    iget-object v1, p0, Landroid/support/design/internal/b$b;->dy:Landroid/graphics/drawable/ColorDrawable;
    ...
    iput-object v1, p0, Landroid/support/design/internal/b$b;->dy:Landroid/graphics/drawable/ColorDrawable;
...
.method final C()V
    ...
    .prologue
    .line 445
    iget-boolean v0, p0, Landroid/support/design/internal/b$b;->dz:Z
    ...
    iput-boolean v0, p0, Landroid/support/design/internal/b$b;->dz:Z
    ...
    invoke-direct {v1}, Landroid/support/design/internal/b$c;-><init>()V
    ...
    iget-object v1, p0, Landroid/support/design/internal/b$b;->dv:Landroid/support/design/internal/b;

    iget-object v1, v1, Landroid/support/design/internal/b;->dn:Landroid/support/v7/view/menu/f;

    invoke-virtual {v1}, Landroid/support/v7/view/menu/f;->dy()Ljava/util/ArrayList;
    ...
    .line 456
    iget-object v0, p0, Landroid/support/design/internal/b$b;->dv:Landroid/support/design/internal/b;

    iget-object v0, v0, Landroid/support/design/internal/b;->dn:Landroid/support/v7/view/menu/f;
    ...
    .line 467
    iget-object v1, p0, Landroid/support/design/internal/b$b;->dw:Ljava/util/ArrayList;

    new-instance v2, Landroid/support/design/internal/b$e;

    iget-object v6, p0, Landroid/support/design/internal/b$b;->dv:Landroid/support/design/internal/b;

    iget v6, v6, Landroid/support/design/internal/b;->du:I
    ...
    invoke-direct {v2, v0}, Landroid/support/design/internal/b$f;-><init>(Landroid/support/v7/view/menu/h;)V
    ...
    invoke-virtual {v1, v12}, Landroid/support/v7/view/menu/h;->E(Z)V
    ...
    .line 484
    :cond_6
    iget-object v12, p0, Landroid/support/design/internal/b$b;->dw:Ljava/util/ArrayList;

    new-instance v13, Landroid/support/design/internal/b$f;

    invoke-direct {v13, v1}, Landroid/support/design/internal/b$f;-><init>(Landroid/support/v7/view/menu/h;)V
    ...
    iget-object v5, p0, Landroid/support/design/internal/b$b;->dv:Landroid/support/design/internal/b;

    iget v5, v5, Landroid/support/design/internal/b;->du:I

    iget-object v9, p0, Landroid/support/design/internal/b$b;->dv:Landroid/support/design/internal/b;

    iget v9, v9, Landroid/support/design/internal/b;->du:I
    ...
    .line 508
    :cond_b
    iget-object v3, p0, Landroid/support/design/internal/b$b;->dw:Ljava/util/ArrayList;

    new-instance v4, Landroid/support/design/internal/b$f;

    invoke-direct {v4, v0}, Landroid/support/design/internal/b$f;-><init>(Landroid/support/v7/view/menu/h;)V
...
.method public final D()Landroid/os/Bundle;
    ...
    .line 541
    iget-object v0, p0, Landroid/support/design/internal/b$b;->dx:Landroid/support/v7/view/menu/h;
    ...
    iget-object v2, p0, Landroid/support/design/internal/b$b;->dx:Landroid/support/v7/view/menu/h;
    ...
    iget-object v4, v0, Landroid/support/design/internal/b$f;->dC:Landroid/support/v7/view/menu/h;
...
.method public final synthetic a(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$t;
    ...
    iget-object v2, p0, Landroid/support/design/internal/b$b;->dv:Landroid/support/design/internal/b;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->dl:Landroid/widget/LinearLayout;
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$t;)V
    ...
    iget-object v0, p1, Landroid/support/design/internal/b$j;->UU:Landroid/view/View;

    check-cast v0, Landroid/support/design/internal/NavigationMenuItemView;

    iget-object v1, v0, Landroid/support/design/internal/NavigationMenuItemView;->dh:Landroid/widget/FrameLayout;
    ...
    :cond_0
    iget-object v0, v0, Landroid/support/design/internal/NavigationMenuItemView;->dg:Landroid/widget/CheckedTextView;
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$t;I)V
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->dj:Landroid/content/res/ColorStateList;

    iput-object v1, v0, Landroid/support/design/internal/NavigationMenuItemView;->dj:Landroid/content/res/ColorStateList;

    iget-object v1, v0, Landroid/support/design/internal/NavigationMenuItemView;->di:Landroid/support/v7/view/menu/h;
    ...
    iget-boolean v1, v1, Landroid/support/design/internal/b;->dq:Z
    ...
    iget v2, v2, Landroid/support/design/internal/b;->dp:I

    iget-object v3, v0, Landroid/support/design/internal/NavigationMenuItemView;->dg:Landroid/widget/CheckedTextView;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->dr:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, v0, Landroid/support/design/internal/NavigationMenuItemView;->dg:Landroid/widget/CheckedTextView;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->ds:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b$f;->dC:Landroid/support/v7/view/menu/h;
    ...
    iget-object v1, p1, Landroid/support/design/internal/b$j;->UU:Landroid/view/View;

    iget v2, v0, Landroid/support/design/internal/b$e;->dA:I

    iget v0, v0, Landroid/support/design/internal/b$e;->dB:I
...
.method public final d(Landroid/support/v7/view/menu/h;)V
    ...
    .line 535
    :cond_2
    iput-object p1, p0, Landroid/support/design/internal/b$b;->dx:Landroid/support/v7/view/menu/h;
