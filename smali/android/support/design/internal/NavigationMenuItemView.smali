...
.field final dg:Landroid/widget/CheckedTextView;

.field dh:Landroid/widget/FrameLayout;

.field di:Landroid/support/v7/view/menu/h;

.field dj:Landroid/content/res/ColorStateList;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/internal/NavigationMenuItemView;->dd:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v1, Landroid/support/design/a$f;->aI:I
    ...
    sget v1, Landroid/support/design/a$d;->am:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->de:I

    .line 69
    sget v0, Landroid/support/design/a$e;->au:I
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dg:Landroid/widget/CheckedTextView;

    .line 70
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dg:Landroid/widget/CheckedTextView;
...
.method public final a(Landroid/support/v7/view/menu/h;)V
    ...
    .line 75
    iput-object p1, p0, Landroid/support/design/internal/NavigationMenuItemView;->di:Landroid/support/v7/view/menu/h;
    ...
    sget-object v3, Landroid/support/design/internal/NavigationMenuItemView;->dd:[I
    ...
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->dg:Landroid/widget/CheckedTextView;
    ...
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dh:Landroid/widget/FrameLayout;

    if-nez v0, :cond_1

    sget v0, Landroid/support/design/a$e;->at:I
    ...
    iput-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dh:Landroid/widget/FrameLayout;
...
.method protected onCreateDrawableState(I)[I
    ...
    .line 169
    iget-object v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->di:Landroid/support/v7/view/menu/h;
    ...
    .line 170
    sget-object v1, Landroid/support/design/internal/NavigationMenuItemView;->dd:[I
...
.method public final setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 150
    iget v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->de:I

    iget v1, p0, Landroid/support/design/internal/NavigationMenuItemView;->de:I

    invoke-virtual {p1, v2, v2, v0, v1}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    .line 151
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->dj:Landroid/content/res/ColorStateList;
...
.method public final z()Landroid/support/v7/view/menu/h;
    ...
    .prologue
    .line 122
    iget-object v0, p0, Landroid/support/design/internal/NavigationMenuItemView;->di:Landroid/support/v7/view/menu/h;
