...
.field private gru:Lcom/tencent/mm/storage/as;


# direct methods
.method public constructor <init>(Lcom/tencent/mm/sdk/e/e;Lcom/tencent/mm/storage/as;)V
    .locals 4

    .prologue
    const-wide v2, 0xa090000000L
    ...
    .line 32
    iput-object p1, p0, Lcom/tencent/mm/y/bm;->fWy:Lcom/tencent/mm/sdk/e/e;

    .line 33
    iput-object p2, p0, Lcom/tencent/mm/y/bm;->gru:Lcom/tencent/mm/storage/as;
...
.method private hi(Ljava/lang/String;)Ljava/lang/String;
    .locals 12

    .prologue
    const-wide v10, 0xa0a0000000L
    ...
    const-string/jumbo v3, "%\' )and username not like \'%@%\' and type"
    ...
    .line 86
    iget-object v3, p0, Lcom/tencent/mm/y/bm;->fWy:Lcom/tencent/mm/sdk/e/e;
    ...
    .line 87
    const-string/jumbo v4, "Micro.SimpleSearchConversationModel"
    ...
    const-string/jumbo v4, "username in ( select chatroomname from "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string/jumbo v4, "chatroom where "
    ...
    const-string/jumbo v2, " and ( rconversation."

    invoke-direct {v1, v2}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    const-string/jumbo v2, "username like \'%"
...
.method public final a(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    const-string/jumbo v2, "username = rcontact."
    ...
    const-string/jumbo v3, "select 1,"

    invoke-direct {v2, v3}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    const-string/jumbo v3, "unReadCount, status, "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, "isSend, conversationTime, "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, "rconversation.username, "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, "content, rconversation."

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, "msgType, rconversation."

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, "flag, rcontact."

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string/jumbo v3, "nickname from rconversation,"
    ...
    invoke-direct {p0, p3}, Lcom/tencent/mm/y/bm;->hi(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "rconversation.username like \'%"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string/jumbo v1, "@chatroom\' asc, "
    ...
    iget-object v1, p0, Lcom/tencent/mm/y/bm;->fWy:Lcom/tencent/mm/sdk/e/e;
