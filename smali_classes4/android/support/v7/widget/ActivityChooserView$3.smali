...
.method constructor <init>(Landroid/support/v7/widget/ActivityChooserView;Landroid/view/View;)V
    ...
    .prologue
    .line 240
    iput-object p1, p0, Landroid/support/v7/widget/ActivityChooserView$3;->NL:Landroid/support/v7/widget/ActivityChooserView;
...
.method protected final dZ()Z
    ...
    .prologue
    .line 254
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView$3;->NL:Landroid/support/v7/widget/ActivityChooserView;
...
.method protected final do()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActivityChooserView;->en()Z

    move-result v1

    if-nez v1, :cond_0

    iget-boolean v1, v0, Landroid/support/v7/widget/ActivityChooserView;->gx:Z
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/ActivityChooserView;->NI:Z

    iget v1, v0, Landroid/support/v7/widget/ActivityChooserView;->NJ:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ActivityChooserView;->aE(I)V
