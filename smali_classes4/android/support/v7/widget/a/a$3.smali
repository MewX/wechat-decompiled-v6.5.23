...
.field final synthetic aab:Landroid/support/v7/widget/RecyclerView$t;
...
.method constructor <init>(Landroid/support/v7/widget/a/a;Landroid/support/v7/widget/RecyclerView$t;IIFFFFILandroid/support/v7/widget/RecyclerView$t;)V
    ...
    .prologue
    .line 611
    iput-object p1, p0, Landroid/support/v7/widget/a/a$3;->ZZ:Landroid/support/v7/widget/a/a;

    iput p9, p0, Landroid/support/v7/widget/a/a$3;->aaa:I

    iput-object p10, p0, Landroid/support/v7/widget/a/a$3;->aab:Landroid/support/v7/widget/RecyclerView$t;
...
.method public final a(Landroid/support/v4/a/g;)V
    ...
    .line 615
    iget-boolean v0, p0, Landroid/support/v7/widget/a/a$3;->aaq:Z
    ...
    .line 618
    :cond_1
    iget v0, p0, Landroid/support/v7/widget/a/a$3;->aaa:I

    if-gtz v0, :cond_3

    .line 620
    iget-object v0, p0, Landroid/support/v7/widget/a/a$3;->ZZ:Landroid/support/v7/widget/a/a;

    iget-object v0, v0, Landroid/support/v7/widget/a/a;->ZM:Landroid/support/v7/widget/a/a$a;

    iget-object v1, p0, Landroid/support/v7/widget/a/a$3;->ZZ:Landroid/support/v7/widget/a/a;

    iget-object v1, v1, Landroid/support/v7/widget/a/a;->Ub:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, p0, Landroid/support/v7/widget/a/a$3;->aab:Landroid/support/v7/widget/RecyclerView$t;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/a/a$3;->aab:Landroid/support/v7/widget/RecyclerView$t;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/a/a;->by(Landroid/view/View;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/a/a;->ZB:Ljava/util/List;
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/a/a$3;->aan:Z
    ...
    iget v1, p0, Landroid/support/v7/widget/a/a$3;->aaa:I
