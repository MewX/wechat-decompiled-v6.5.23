...
.method private static c(Landroid/support/v7/widget/o;)F
    ...
    iget v0, v0, Landroid/support/v7/widget/ae;->Vl:F
...
.method public final a(Landroid/support/v7/widget/o;Landroid/content/Context;IFFF)V
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/o;->eC()Z
    ...
    iget v3, v0, Landroid/support/v7/widget/ae;->Vo:F

    cmpl-float v3, p6, v3

    if-nez v3, :cond_0

    iget-boolean v3, v0, Landroid/support/v7/widget/ae;->Vp:Z

    if-ne v3, v1, :cond_0

    iget-boolean v3, v0, Landroid/support/v7/widget/ae;->Vq:Z

    if-eq v3, v2, :cond_1

    :cond_0
    iput p6, v0, Landroid/support/v7/widget/ae;->Vo:F

    iput-boolean v1, v0, Landroid/support/v7/widget/ae;->Vp:Z

    iput-boolean v2, v0, Landroid/support/v7/widget/ae;->Vq:Z
    ...
    iget v0, v0, Landroid/support/v7/widget/ae;->Vo:F
