...
.field protected AG:Landroid/support/v4/widget/e$a;

.field protected AH:Landroid/database/DataSetObserver;

.field protected AI:Landroid/support/v4/widget/f;

.field protected AJ:Landroid/widget/FilterQueryProvider;
...
.method public changeCursor(Landroid/database/Cursor;)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/e;->AG:Landroid/support/v4/widget/e$a;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v4/widget/e;->AH:Landroid/database/DataSetObserver;
    ...
    :cond_3
    iput-object p1, p0, Landroid/support/v4/widget/e;->AE:Landroid/database/Cursor;
    ...
    iput v1, p0, Landroid/support/v4/widget/e;->AF:I

    const/4 v1, 0x1

    iput-boolean v1, p0, Landroid/support/v4/widget/e;->AC:Z
...
.method public getCount()I
    ...
    .prologue
    .line 201
    iget-boolean v0, p0, Landroid/support/v4/widget/e;->AC:Z
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/e;->AE:Landroid/database/Cursor;
...
.method public getFilter()Landroid/widget/Filter;
    ...
    .prologue
    .line 404
    iget-object v0, p0, Landroid/support/v4/widget/e;->AI:Landroid/support/v4/widget/f;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/e;->AI:Landroid/support/v4/widget/f;
...
.method public getItemId(I)J
    ...
    .line 224
    iget-boolean v2, p0, Landroid/support/v4/widget/e;->AC:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Landroid/support/v4/widget/e;->AE:Landroid/database/Cursor;
    ...
    iget v1, p0, Landroid/support/v4/widget/e;->AF:I
...
.method protected final onContentChanged()V
    ...
    .prologue
    .line 447
    iget-boolean v0, p0, Landroid/support/v4/widget/e;->AD:Z
    ...
    iput-boolean v0, p0, Landroid/support/v4/widget/e;->AC:Z
...
.method public runQueryOnBackgroundThread(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    .prologue
    .line 396
    iget-object v0, p0, Landroid/support/v4/widget/e;->AJ:Landroid/widget/FilterQueryProvider;
