...
.method public static a([B)Lcom/tencent/mm/opensdk/diffdev/a/d$a;
    ...
    const-string/jumbo v3, "writeToFile fail, qrcodeBuf length = %d"
    ...
    const-string/jumbo v2, "parse succ, save in external storage, uuid = %s, appname = %s, imgPath = %s"
...
.method private static a(Ljava/lang/String;[B)Z
    ...
    :goto_0
    const-string/jumbo v0, "MicroMsg.SDK.GetQRCodeResult"
    ...
    const-string/jumbo v3, "fout.close() exception:"
    ...
    const-string/jumbo v4, "write to file error, exception:"
    ...
    const-string/jumbo v4, "fout.close() exception:"
