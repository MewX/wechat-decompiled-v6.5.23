...
.method private a(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kM()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kO()Ljava/lang/Class;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->kG()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kL()Z
...
.method private static a(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kI()I
    ...
    invoke-static {p2}, Lcom/google/android/gms/c/x;->as(Ljava/lang/String;)Ljava/lang/String;
...
# virtual methods
.method public abstract kF()Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/Map",
...
.method protected abstract kG()Ljava/lang/Object;
.end method
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->kF()Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kK()I
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kL()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kM()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->kH()Z
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kJ()Z
    ...
    invoke-static {v2}, Lcom/google/android/gms/c/s;->f([B)Ljava/lang/String;
