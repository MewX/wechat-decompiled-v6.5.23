...
# instance fields
.field final alZ:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

.field private final amh:Landroid/os/Parcel;
...
.method constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amh:Landroid/os/Parcel;

    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->ami:I

    iput-object p3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->alZ:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->alZ:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    if-nez v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->qj:Ljava/lang/String;

    :goto_0
    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amj:I
    ...
    iget-object v0, v0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->amd:Ljava/lang/String;
...
.method private static a(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/c/x;->as(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/gms/c/s;->f([B)Ljava/lang/String;
...
.method private a(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kL()Z
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kK()I
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kQ()Ljava/util/Map;
    ...
    invoke-static {v0}, Lcom/google/android/gms/c/x;->as(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/gms/c/s;->f([B)Ljava/lang/String;
...
.method private a(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kN()I
    ...
    iget-object v1, v0, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->ama:Lcom/google/android/gms/common/server/response/FastJsonResponse$a;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kK()I
    ...
    invoke-static {v1}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->h(Landroid/os/Bundle;)Ljava/util/HashMap;
...
.method private b(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kJ()Z
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kI()I
...
.method private static h(Landroid/os/Bundle;)Ljava/util/HashMap;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final kF()Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->qj:Ljava/lang/String;
...
.method protected final kG()Ljava/lang/Object;
    .locals 2
...
.method public final kT()Landroid/os/Parcel;
    .locals 2

    iget v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amj:I

    packed-switch v0, :pswitch_data_0

    :goto_0
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amh:Landroid/os/Parcel;
    ...
    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amk:I

    :pswitch_1
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amh:Landroid/os/Parcel;

    iget v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amk:I

    invoke-static {v0, v1}, Lcom/google/android/gms/common/internal/safeparcel/b;->u(Landroid/os/Parcel;I)V

    const/4 v0, 0x2

    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->amj:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->kT()Landroid/os/Parcel;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->alZ:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->qj:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->aj(Ljava/lang/String;)Ljava/util/Map;
