var NativeGlobal = function (window) {
    ...
    _public.EventHandler = function () {
        ...
        var destructiveEventHandler = new Ejecta.DestructiveObjectEventHandler();
        ...
        result.__triggerTouchEvent__ = function () {
            ...
            function TouchEvent(pointers, actionIndexList, timeStamp) {
            ...
            return function (native) {
                ...
                var touchEvent = new TouchEvent(native[0], native[1], native[2]);
                if (touchEvent === null) {
                    return;
                }
                callback(touchEvent);
    ...
    _public.setPreferredFramesPerSecond = (function () {
        // 控制帧率
//        if (typeof window.WeixinJSCore === 'undefined') {
//            return ej.setPreferredFramesPerSecond;//未实现
//        }

        var core = window.WeixinJSCore;
        return function (fps) {
            console.log("setPreferredFramesPerSecond");
            var data = {'fps': fps };
