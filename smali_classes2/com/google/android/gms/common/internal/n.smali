...
# instance fields
.field public final adf:Landroid/content/Context;

.field public final alt:Ljava/util/HashMap;
...
.field public final alu:Lcom/google/android/gms/common/stats/b;

.field private final alv:J
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/internal/n;->alt:Ljava/util/HashMap;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/common/internal/n;->adf:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/internal/n;->alu:Lcom/google/android/gms/common/stats/b;

    const-wide/16 v0, 0x1388

    iput-wide v0, p0, Lcom/google/android/gms/common/internal/n;->alv:J
...
.method private a(Lcom/google/android/gms/common/internal/n$a;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2, v2}, Lcom/google/android/gms/common/internal/w;->j(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v9, p0, Lcom/google/android/gms/common/internal/n;->alt:Ljava/util/HashMap;

    monitor-enter v9

    :try_start_0
    iget-object v2, p0, Lcom/google/android/gms/common/internal/n;->alt:Ljava/util/HashMap;
    ...
    :cond_1
    iget-object v2, v8, Lcom/google/android/gms/common/internal/n$b;->alD:Lcom/google/android/gms/common/internal/n;

    iget-object v2, v2, Lcom/google/android/gms/common/internal/n;->alu:Lcom/google/android/gms/common/stats/b;

    iget-object v3, v8, Lcom/google/android/gms/common/internal/n$b;->alD:Lcom/google/android/gms/common/internal/n;

    iget-object v3, v3, Lcom/google/android/gms/common/internal/n;->adf:Landroid/content/Context;
    ...
    iget-object v2, v8, Lcom/google/android/gms/common/internal/n$b;->alA:Ljava/util/Set;

    invoke-interface {v2, p2}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    invoke-virtual {v8}, Lcom/google/android/gms/common/internal/n$b;->kC()Z
    ...
    iget-wide v4, p0, Lcom/google/android/gms/common/internal/n;->alv:J
...
.method private a(Lcom/google/android/gms/common/internal/n$a;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/internal/n;->alt:Ljava/util/HashMap;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/common/internal/n;->alt:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, p3}, Lcom/google/android/gms/common/internal/n$b;->ad(Ljava/lang/String;)V
    ...
    :goto_0
    iget-boolean v0, v0, Lcom/google/android/gms/common/internal/n$b;->alB:Z
    ...
    :pswitch_0
    iget-object v2, v0, Lcom/google/android/gms/common/internal/n$b;->aly:Landroid/content/ComponentName;

    iget-object v3, v0, Lcom/google/android/gms/common/internal/n$b;->ajT:Landroid/os/IBinder;
...
.method public final handleMessage(Landroid/os/Message;)Z
    ...
    :try_start_0
    invoke-virtual {v0}, Lcom/google/android/gms/common/internal/n$b;->kC()Z

    move-result v2

    if-eqz v2, :cond_1

    iget-boolean v2, v0, Lcom/google/android/gms/common/internal/n$b;->alB:Z

    if-eqz v2, :cond_0

    iget-object v2, v0, Lcom/google/android/gms/common/internal/n$b;->alD:Lcom/google/android/gms/common/internal/n;

    iget-object v2, v2, Lcom/google/android/gms/common/internal/n;->alu:Lcom/google/android/gms/common/stats/b;

    iget-object v3, v0, Lcom/google/android/gms/common/internal/n$b;->alD:Lcom/google/android/gms/common/internal/n;

    iget-object v3, v3, Lcom/google/android/gms/common/internal/n;->adf:Landroid/content/Context;

    iget-object v4, v0, Lcom/google/android/gms/common/internal/n$b;->alz:Lcom/google/android/gms/common/internal/n$b$a;
    ...
    iput-boolean v2, v0, Lcom/google/android/gms/common/internal/n$b;->alB:Z
    ...
    iget-object v0, v0, Lcom/google/android/gms/common/internal/n$b;->alC:Lcom/google/android/gms/common/internal/n$a;
