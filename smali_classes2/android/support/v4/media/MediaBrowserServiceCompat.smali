...
# instance fields
.field private final tw:Landroid/support/v4/e/a;
...
.field private final tx:Landroid/support/v4/media/MediaBrowserServiceCompat$f;

.field ty:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->tw:Landroid/support/v4/e/a;
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->tx:Landroid/support/v4/media/MediaBrowserServiceCompat$f;
...
.method static synthetic a(Landroid/support/v4/media/MediaBrowserServiceCompat;)Landroid/support/v4/media/MediaBrowserServiceCompat$f;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->tx:Landroid/support/v4/media/MediaBrowserServiceCompat$f;
...
.method static synthetic a(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$b;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 73
    iget-object v0, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->tJ:Ljava/util/HashMap;
    ...
    iput v1, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tu:I
    ...
    iget-object v2, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->tF:Ljava/lang/String;
...
.method static synthetic a(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tM:Z
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tK:Ljava/lang/Object;
    ...
    iput-boolean v1, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tM:Z

    const/4 v1, 0x0

    iget v2, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tu:I
...
.method static synthetic a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$b;Landroid/os/Bundle;)Z
    ...
    iget-object v0, p1, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->tJ:Ljava/util/HashMap;
...
.method static synthetic b(Landroid/support/v4/media/MediaBrowserServiceCompat;)Landroid/support/v4/e/a;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->tw:Landroid/support/v4/e/a;
...
# virtual methods
.method public abstract bw()Landroid/support/v4/media/MediaBrowserServiceCompat$a;
.end method
